...
namespace FreeSims.Xbox.Proof
{
    public static class Program
    {
        ...
        {
            ProofLog.Write("START COMMON PROBE commit=" + BuildInfo.Commit + " platform=x64 configuration=Release");
            ...
            try
            {
                CoreApplication.Run(new GameFrameworkViewSource<CommonProbeGame>());
            }
            catch (Exception ex)
            {
