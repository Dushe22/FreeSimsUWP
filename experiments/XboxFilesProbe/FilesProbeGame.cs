...
{
    public sealed class FilesProbeGame : Game
    {
        ...
        private void RunTests()
        {
            ...
            results = FilesCompatibilityTests.Run(ProofLog.Write, GraphicsDevice);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            PixelText.Draw(batch, pixel, passed ? "10/10 PASS" : "TEST FAILURE - SEE LOG",
