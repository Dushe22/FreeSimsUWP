...
namespace FreeSims.Xbox.Proof
{
    public static class Program
    {
        ...
        {
            ProofLog.Write("START FILES PROBE commit=" + BuildInfo.Commit + " platform=x64 configuration=Release");
            ...
            try
            {
                CoreApplication.Run(new GameFrameworkViewSource<FilesProbeGame>());
            }
            catch (Exception ex)
            {
